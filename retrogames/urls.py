...
from retroapi.views import register_user, login_user, GameView, OwnerView, ConsoleView, GenreView, ControllerView, ConsoleCollectionView, ControllerCollectionView, GameCollectionView, ConditionView
...
router.register(r'gamecollections', GameCollectionView, 'gamecollection')
